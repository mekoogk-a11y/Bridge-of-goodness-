...
export const INITIATIVE_INFO = {
  ...
  engagement: {
    titleAr: '🤝 شارك في صناعة الأثر',
    titleEn: '🤝 Partner in Creating Impact',
    descriptionAr: '«مبادرة جسور الخير تقوم على سواعد المتطوعين والشراكات المؤسسية لنقل المعرفة وبناء القدرات المجتمعية.»',
    descriptionEn: '“Bridges of Goodness thrives on volunteer expertise and institutional partnerships to transfer knowledge and foster community self-reliance.”',
  },
  whatsapp: {
