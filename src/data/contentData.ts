...
export const INITIATIVE_INFO = {
  ...
  legalNoticeAr: 'جسور الخير في مرحلتها الحالية هي فكرة تأسيسية ومبادرة مجتمعية مقترحة قيد الدراسة والتطوير، وليست بعد منظمة مسجلة رسمياً أو جهة قائمة، ولا تطلب أو تجمع تبرعات مالية في هذه المرحلة. جميع المشاريع والبرامج المعروضة تمثل تصورات ورؤى مستقبلية مقترحة.',
  legalNoticeEn: 'Bridges of Goodness is currently a foundational concept and proposed community initiative under active development. It is not yet a registered NGO or legal entity, and does not solicit financial donations at this stage. All initiatives displayed are proposed future concepts.',
  heroDescriptionAr: 'جسور الخير مبادرة تأسيسية قيد التطوير، انطلقت فكرتها من إيمان بأن العمل الإنساني لا ينبغي أن يتوقف عند تقديم المساعدة، بل يمكن أن يمتد إلى بناء المعرفة والمهارة والفرصة والقدرة على صناعة المستقبل.',
  heroDescriptionEn: 'Bridges of Goodness is a foundational initiative under development, born from the conviction that humanitarian effort must transcend temporary relief into cultivating knowledge, skills, opportunities, and the power to shape a self-reliant future.',
